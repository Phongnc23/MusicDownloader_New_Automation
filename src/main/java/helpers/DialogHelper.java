...
public class DialogHelper {
    ...
    // Cua so cho dialog "Update app" xuat hien sau khi app len foreground. Dialog nay hien
    // gan nhu ngay (~1s) -> 2s du bat, khong phai cho lau moi test. (Mid-run dung
    // dismissUpdateDialogIfPresent.)
    private static final long INITIAL_WAIT_MS = 2_000;
